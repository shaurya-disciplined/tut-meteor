...
export const DOSSIER_FILES = [
  ...
  },
  {
    ...
    body: "Volleyball is fundamentally an exercise in predictive logic and spatial awareness. You aren't just reacting to the ball; you are reading the kinetic chain of the opponent. The angle of their shoulders, the placement of the setter's hands, the trajectory of the toss—all of it is data.\\n\\nWe didn't just play; we ran the school tournaments. We turned up to win. That required understanding team dynamics, identifying the weak link in a defense, and ruthlessly exploiting it. It’s an asymmetric game. A single, perfectly timed block can demoralize a team more than a dozen normal points. \\n\\nThe court taught me how to move within a system of other people, how to cover blind spots, and how to anticipate where the game is going before the ball even crosses the net.",
  ...
  },
  {
    ...
    body: "I play chess properly, which means I don't look at the board; I look at the lines. It is a strictly deterministic environment. If I execute A, the opponent must respond with B or C. It forces you into a state of deep, branching computation.\\n\\nCards, on the other hand, are probabilistic. You never have perfect information. You don't know the exact outcome, but if you understand math and psychology, you know the odds. You learn when to fold a bad hand and when to aggressively leverage a good one.\\n\\nI don't play either competitively anymore, but the mental frameworks are permanent. Whether I am architecting a new AI memory fabric like Aethermem or analyzing market psychology, I am essentially just toggling between the deterministic logic of chess and the probabilistic risk assessment of cards.",
  ...
  },
  {
    ...
    body: "In a life heavily indexed on optimization, scale, and asymmetric leverage, playing the guitar is a deliberate anomaly. It is one of the only things I do that isn't measured by ROI.\\n\\nThere is something profoundly grounding about the tactile resistance of steel strings. It’s an analog mechanism. When you spend the majority of your time dealing in the abstract—writing code, structuring SaaS architectures, studying LLM context management—you need an anchor. \\n\\nI play purely because it sounds good. The mechanical act of fretting a chord and forcing it to ring out perfectly is a necessary counterbalance to the hyper-analytical speed of everything else.",
